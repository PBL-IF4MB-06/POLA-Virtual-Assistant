...
### 4.2.4 Rekapitulasi Pengujian

**Tabel 4.5 Rekapitulasi Hasil Pengujian**

| Jenis Pengujian | Jumlah Kasus | Berhasil | Gagal |
|-----------------|:------------:|:--------:|:-----:|
| Fungsional (FR-01 s.d. FR-25) | 25 | 25 | 0 |
| API Backend AI | 4 | 4 | 0 |
| Integrasi Antarmodul | 6 | 6 | 0 |
| **Total** | **35** | **35** | **0** |

---

### 4.2.5 Pembahasan Hasil Pengujian
