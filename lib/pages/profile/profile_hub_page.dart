                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    _MenuCard(
                      ...
                      title: auth.isAdmin ? 'Panel Admin' : 'Login Admin',
                      subtitle: auth.isAdmin
                          ? 'Kelola FAQ & monitoring sistem'
                          : 'Masuk dengan akun admin POLA',
                      onTap: () {
                        if (auth.isAdmin) {
                          _push(context, const AdminDashboardPage());
                        } else {
                          _push(context, const AdminLoginPage());
                        }
                      },
                    ),
